...
#import "../Application/AAPLConfig.h"
                        ...
                        drawablePixelFormat:(MTLPixelFormat)drawabklePixelFormat
{
    ...
    if (self)
    {
...

        {
            ...
            NSURL* pURL = [ NSURL fileURLWithPath:@"/Users/noma/Desktop/dev/oaz_engine/engine/src/platform/app_manager_macos/Renderer/AAPLShaders.metallib" isDirectory:NO ];
            //NSError* pError = [[NSError alloc] init];
            id<MTLLibrary> shaderLib = [_device newLibraryWithURL:pURL error:nil];
            if(!shaderLib)
            {
                //NSLog(@"ERROR: %@", pError.domain);
